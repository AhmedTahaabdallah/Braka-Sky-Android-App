...
public class ShowdisLikesPostsUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showdis_likes_posts_users_normal);
        ...
        PostssRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(post_key).child("disLikesPosts");
        ...
        //waitingBar = new SpotsDialog.Builder().setContext(ShowdisLikesPostsUsersActivity.this).build();
        mainRoot = (RelativeLayout) findViewById(R.id.main_showdislikeposts_root);

        myFriendsList = (RecyclerView) findViewById(R.id.show_dislikes_posts_users_list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        myFriendsList.setLayoutManager(linearLayoutManager);
        simpletextid = (TextView) findViewById(R.id.all_show_dislikes_posts_users_textsimple);


    }

    private void getUserFullNme(){
        UserFullnameRefValue = new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    String userfullname = dataSnapshot.child("fullname").getValue().toString();
                    String fi = getResources().getString(R.string.show_dislikes_posts_users_simpletext_before) + " " + userfullname + " " + getResources().getString(R.string.show_dislikes_posts_users_simpletext_after);
    ...
    private void DisplayAllLikesPostUsers() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ShowUsers, ShowdisLikesPostsUsersActivity.ShowUsersViewHolder>(options) {

            @NonNull
            @Override
            public ShowdisLikesPostsUsersActivity.ShowUsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.all_users_display_layout_normal, parent, false);

                return new ShowdisLikesPostsUsersActivity.ShowUsersViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull final ShowdisLikesPostsUsersActivity.ShowUsersViewHolder holder, int position, @NonNull ShowUsers model) {
                            ...
                            holder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (current_uid.equals(usersIds)){
                                        transfer = "true";
                                        Intent intent = new Intent(ShowdisLikesPostsUsersActivity.this, ProfileActivity.class);
                                        startActivity(intent);
                                    } else {
                                        transfer = "true";
                                        Intent intent = new Intent(ShowdisLikesPostsUsersActivity.this, PersonProfileActivity.class);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (timeisoff == 1) {
                ...
                Toast.makeText(ShowdisLikesPostsUsersActivity.this, "Please Select  automatic date & time from Settings", Toast.LENGTH_LONG).show();
