...
public class ShowLikeReplayMainCommentUsersActivity extends AppCompatActivity {
    ...
    private String post_key, post_uid, ccpost_key, replay_key, current_uid, transfer = "false";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_like_replay_main_comment_users_normal);
        ...
        replay_key = getIntent().getExtras().get("replay_key").toString();
        ...
        PostssRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(post_key).child("Maincomments").child(ccpost_key).child("Replays").child(replay_key).child("LikesReplays");
        ...
        //waitingBar = new SpotsDialog.Builder().setContext(ShowLikeReplayMainCommentUsersActivity.this).build();
        mainRoot = (RelativeLayout) findViewById(R.id.main_showlikereplaymaincomments_root);

        myFriendsList = (RecyclerView) findViewById(R.id.show_like_replay_main_comments_users_list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        myFriendsList.setLayoutManager(linearLayoutManager);
        simpletextid = (TextView) findViewById(R.id.all_show_like_replay_main_comments_users_textsimple);
        ...
        UserFullnameRefValue = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    String fi = getResources().getString(R.string.show_like_replays_main_comments_users_simpletext_before) + " " + userfullname + " " + getResources().getString(R.string.show_like_replays_main_comments_users_simpletext_after);
    ...
    private void DisplayAllLikesPostUsers() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ShowUsers, ShowLikeReplayMainCommentUsersActivity.ShowUsersViewHolder>(options) {

            @NonNull
            @Override
            public ShowLikeReplayMainCommentUsersActivity.ShowUsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.all_users_display_layout_normal, parent, false);

                return new ShowLikeReplayMainCommentUsersActivity.ShowUsersViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull final ShowLikeReplayMainCommentUsersActivity.ShowUsersViewHolder holder, int position, @NonNull ShowUsers model) {
                            ...
                            holder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (current_uid.equals(usersIds)){
                                        transfer = "true";
                                        Intent intent = new Intent(ShowLikeReplayMainCommentUsersActivity.this, ProfileActivity.class);
                                        startActivity(intent);
                                    } else {
                                        transfer = "true";
                                        Intent intent = new Intent(ShowLikeReplayMainCommentUsersActivity.this, PersonProfileActivity.class);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (timeisoff == 1) {
                ...
                Toast.makeText(ShowLikeReplayMainCommentUsersActivity.this, "Please Select  automatic date & time from Settings", Toast.LENGTH_LONG).show();
