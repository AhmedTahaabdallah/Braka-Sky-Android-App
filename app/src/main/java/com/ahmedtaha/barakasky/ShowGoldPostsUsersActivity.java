...
public class ShowGoldPostsUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_gold_posts_users_normal);
        ...
        PostssRef = FirebaseDatabase.getInstance().getReference().child("GoldPosts").child(post_key).child("LikesGoldPosts");
        ...
        //waitingBar = new SpotsDialog.Builder().setContext(ShowGoldPostsUsersActivity.this).build();
        mainRoot = (RelativeLayout) findViewById(R.id.main_showgoldposts_root);


        myFriendsList = (RecyclerView) findViewById(R.id.show_gold_posts_users_list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        myFriendsList.setLayoutManager(linearLayoutManager);
        simpletextid = (TextView) findViewById(R.id.all_show_gold_posts_users_textsimple);
        ...
        UserFullnameRefValue = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    String fi = getResources().getString(R.string.show_gold_posts_users_simpletext_before) + " " + userfullname + " " + getResources().getString(R.string.show_gold_posts_users_simpletext_after);
    ...
    private void DisplayAllLikesPostUsers() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ShowUsers, ShowGoldPostsUsersActivity.ShowUsersViewHolder>(options) {

            @NonNull
            @Override
            public ShowGoldPostsUsersActivity.ShowUsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.all_users_display_layout_normal, parent, false);

                return new ShowGoldPostsUsersActivity.ShowUsersViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull final ShowGoldPostsUsersActivity.ShowUsersViewHolder holder, int position, @NonNull ShowUsers model) {
                            ...
                            holder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (current_uid.equals(usersIds)){
                                        transfer = "true";
                                        Intent intent = new Intent(ShowGoldPostsUsersActivity.this, ProfileActivity.class);
                                        startActivity(intent);
                                    } else {
                                        transfer = "true";
                                        Intent intent = new Intent(ShowGoldPostsUsersActivity.this, PersonProfileActivity.class);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (timeisoff == 1) {
                ...
                Toast.makeText(ShowGoldPostsUsersActivity.this, "Please Select  automatic date & time from Settings", Toast.LENGTH_LONG).show();
