...
public class ShowLikeMainCommentsUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_like_main_comments_users_normal);
        ...
        PostssRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(post_key).child("Maincomments").child(ccpost_key).child("LikesMainComments");
        ...
        //waitingBar = new SpotsDialog.Builder().setContext(ShowLikeMainCommentsUsersActivity.this).build();
        mainRoot = (RelativeLayout) findViewById(R.id.main_showlikemaincomments_root);

        myFriendsList = (RecyclerView) findViewById(R.id.show_like_main_comments_users_list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        myFriendsList.setLayoutManager(linearLayoutManager);
        simpletextid = (TextView) findViewById(R.id.all_show_like_main_comments_users_textsimple);
        ...
        UserFullnameRefValue = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    String fi = getResources().getString(R.string.show_like_main_comments_users_simpletext_before) + " " + userfullname + " " + getResources().getString(R.string.show_like_main_comments_users_simpletext_after);
    ...
    private void DisplayAllLikesPostUsers() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ShowUsers, ShowLikeMainCommentsUsersActivity.ShowUsersViewHolder>(options) {

            @NonNull
            @Override
            public ShowLikeMainCommentsUsersActivity.ShowUsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.all_users_display_layout_normal, parent, false);

                return new ShowLikeMainCommentsUsersActivity.ShowUsersViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull final ShowLikeMainCommentsUsersActivity.ShowUsersViewHolder holder, int position, @NonNull ShowUsers model) {
                            ...
                            holder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (current_uid.equals(usersIds)){
                                        transfer = "true";
                                        Intent intent = new Intent(ShowLikeMainCommentsUsersActivity.this, ProfileActivity.class);
                                        startActivity(intent);
                                    } else {
                                        transfer = "true";
                                        Intent intent = new Intent(ShowLikeMainCommentsUsersActivity.this, PersonProfileActivity.class);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (timeisoff == 1) {
                ...
                Toast.makeText(ShowLikeMainCommentsUsersActivity.this, "Please Select  automatic date & time from Settings", Toast.LENGTH_LONG).show();
