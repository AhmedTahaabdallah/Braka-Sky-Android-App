...
public class ShowCommentsPostsUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_comments_posts_users_normal);
        ...
        PostssRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(post_key).child("Maincomments");
        ...
        //waitingBar = new SpotsDialog.Builder().setContext(ShowCommentsPostsUsersActivity.this).build();
        mainRoot = (RelativeLayout) findViewById(R.id.main_showcommentsposts_root);

        myFriendsList = (RecyclerView) findViewById(R.id.show_comments_posts_users_list);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        myFriendsList.setLayoutManager(linearLayoutManager);
        simpletextid = (TextView) findViewById(R.id.all_show_comments_posts_users_textsimple);
        ...
        UserFullnameRefValue = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    String fi = getResources().getString(R.string.show_comments_posts_users_simpletext_before) + " " + userfullname + " " + getResources().getString(R.string.show_comments_posts_users_simpletext_after);
    ...
    private void DisplayAllLikesPostUsers() {
       // final List<String> list;
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ShowUsers, ShowCommentsPostsUsersActivity.ShowUsersViewHolder>(options) {

            @NonNull
            @Override
            public ShowCommentsPostsUsersActivity.ShowUsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.all_users_display_layout_normal, parent, false);

                return new ShowCommentsPostsUsersActivity.ShowUsersViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull final ShowCommentsPostsUsersActivity.ShowUsersViewHolder holder, int position, @NonNull ShowUsers model) {
                        ...
                        if (dataSnapshot.exists()){
                            ...
                            usergetRefValue = new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    //Boolean dd = hashMap.containsKey(usersIds);
                                    if(dataSnapshot.exists()){
                                        ...
                                        holder.mView.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                if (current_uid.equals(usersIds)){
                                                    transfer = "true";
                                                    Intent intent = new Intent(ShowCommentsPostsUsersActivity.this, ProfileActivity.class);
                                                    startActivity(intent);
                                                } else {
                                                    transfer = "true";
                                                    Intent intent = new Intent(ShowCommentsPostsUsersActivity.this, PersonProfileActivity.class);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (timeisoff == 1) {
                ...
                Toast.makeText(ShowCommentsPostsUsersActivity.this, "Please Select  automatic date & time from Settings", Toast.LENGTH_LONG).show();
